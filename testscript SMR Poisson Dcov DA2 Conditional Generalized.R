...
source("NimbleModel SMR Poisson Dcov DA2 Conditional Generalized.R")
source("NimbleFunctions SMR Poisson Dcov DA2 Conditional Generalized.R")
...
obstype <- "poisson" #for sighting process. can also simulate "negbin"
...
inits <- list(p0=0.5,lam0=1,sigma=1,theta.marked=theta.marked.init,theta.unmarked=theta.unmarked.init)

#This function structures the simulated data to fit the model in Nimble (some more restructing below)
#Also checks some inits
nimbuild <- init.SMR.Dcov.Generalized(data,inits,M=M,obsmod="poisson")
